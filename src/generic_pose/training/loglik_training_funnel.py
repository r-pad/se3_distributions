...
from generic_pose.losses.loglik_loss import evaluateLikelihood
...
def main():
    ...
    from generic_pose.models.compare_networks import SigmoidCompareFunnelNet, SigmoidFunnelNet
    ...
    if(args.use_comparison):
        model = SigmoidCompareFunnelNet(args.feature_size, num_objects)
    else:
        model = SigmoidFunnelNet(args.feature_size, 3885*num_objects)
