...
class FinetuneYCBTrainer(object):
    def __init__(self, 
        ...
        self.render_dataset = PoseRendererDataset(self.ycb_dataset.getModelFilename(),
                                                  epoch_size = int(render_proportion * len(self.ycb_dataset)),
                                                  img_size=img_size,
                                                  brightness_jitter = brightness_jitter,
                                        contrast_jitter = contrast_jitter,
                                        saturation_jitter = saturation_jitter,
        ...
        self.render_dataset.loop_truth = None
        self.render_dataset.append_rendered = use_exact_render
        print("Renders Loaded")
        self.train_dataset = ConcatDataset((self.ycb_dataset, self.render_dataset))
        ...
        self.renderer = self.render_dataset.renderer
