...
from generic_pose.training.dynamics_utils import evaluateFeatureDynamics
                        ...
                        if(num_display_imgs > 0):
                            ...
                            if(self.cross_model_eval):
                                ...
                                valid_render_cross_imgs = renderQuaternions(valid_query_imgs, valid_cross_imgs,
                                                                     ...
                                                                     trainingmodel_files = v_model_files[1][:num_display_imgs],
                                                                     camera_dist = self.render_distance)                    
...
def main():
    ...
    from generic_pose.models.dynamics_networks import gen_dyn_net
    ...
    trainer = DynamicsTrainer(train_data_folder = args.train_data_folder,
    ...
    model = gen_dyn_net(args.model_type.lower(), 
