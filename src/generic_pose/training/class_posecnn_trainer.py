...
class FinetuneYCBTrainer(object):
    def __init__(self, 
        ...
        self.ycb_dataset.vgg_normalize = True
        self.ycb_dataset.background = 0.0
        ...
        self.rendered_dataset.vgg_normalize = True
        self.rendered_dataset.background = 0.0
        ...
        self.valid_dataset.vgg_normalize = True
        self.valid_dataset.background = 0.0
...
def main():
    ...
    parser.add_argument('--model_type', type=str, default='posecnn')
