...
def rawDistanceLoss(pred, labels, falloff_angle=np.pi/4):
...
def logDistanceLoss(pred, labels, falloff_angle=np.pi/4):
...
def expDistanceLoss(pred, labels, falloff_angle=np.pi/9):
...
def negExpDistanceLoss(pred, labels, falloff_angle=np.pi/9):
