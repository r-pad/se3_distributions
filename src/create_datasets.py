...
from pose_data_loader import PoseDataSetGenerator
import numpy as np

data_dir = '/media/bokorn/ExtraDrive1/render_cnn_data/model_images/syn_images/'
dataset_gen = PoseDataSetGenerator(data_dir)
...
with open('../training_sets/chairs_1_train.txt', 'w') as f:
    for fn in chairs_1_train:
        f.write("%s\n" % fn)
with open('../training_sets/chairs_1_valid.txt', 'w') as f:
...
#with open('../training_sets/chairs_1_deg_5_train.txt', 'w') as f:
#    for fn in chairs_1_deg_5_train:
#        f.write("%s\n" % fn)
#with open('../training_sets/chairs_1_deg_5_valid.txt', 'w') as f:
...
#with open('../training_sets/chairs_1_deg_10_train.txt', 'w') as f:
#    for fn in chairs_1_deg_10_train:
#        f.write("%s\n" % fn)
#with open('../training_sets/chairs_1_deg_10_valid.txt', 'w') as f:
...
with open('../training_sets/chairs_1_deg_20_train.txt', 'w') as f:
    for fn in chairs_1_deg_20_train:
        f.write("%s\n" % fn)
with open('../training_sets/chairs_1_deg_20_valid.txt', 'w') as f:
...
with open('../training_sets/chairs_1_deg_45_train.txt', 'w') as f:
    for fn in chairs_1_deg_45_train:
        f.write("%s\n" % fn)
with open('../training_sets/chairs_1_deg_45_valid.txt', 'w') as f:
...
with open('../training_sets/chairs_1_deg_90_train.txt', 'w') as f:
    for fn in chairs_1_deg_90_train:
        f.write("%s\n" % fn)
with open('../training_sets/chairs_1_deg_90_valid.txt', 'w') as f:
...
with open('../training_sets/chairs_1_deg_135_train.txt', 'w') as f:
    for fn in chairs_1_deg_135_train:
        f.write("%s\n" % fn)
with open('../training_sets/chairs_1_deg_135_valid.txt', 'w') as f:
...
with open('../training_sets/chairs_1_deg_180_train.txt', 'w') as f:
    for fn in chairs_1_deg_180_train:
        f.write("%s\n" % fn)
with open('../training_sets/chairs_1_deg_180_valid.txt', 'w') as f:
...
with open('../training_sets/cars_3_train.txt', 'w') as f:
    for fn in cars_3_train:
        f.write("%s\n" % fn)
with open('../training_sets/cars_3_valid.txt', 'w') as f:
    for fn in cars_3_valid:
        f.write("%s\n" % fn)
        
print('cars_10_train:', len(cars_10_train))
print('cars_10_valid:', len(cars_10_valid))
with open('../training_sets/cars_10_train.txt', 'w') as f:
    for fn in cars_10_train:
        f.write("%s\n" % fn)
with open('../training_sets/cars_10_valid.txt', 'w') as f:
    for fn in cars_10_valid:
        f.write("%s\n" % fn)
        
print('cars_100_train:', len(cars_100_train))
print('cars_100_valid:', len(cars_100_valid))
with open('../training_sets/cars_100_train.txt', 'w') as f:
    for fn in cars_100_train:
        f.write("%s\n" % fn)
with open('../training_sets/cars_100_valid.txt', 'w') as f:
