...
train_folder = '/home/bokorn/src/generic_pose/generic_pose/training_sets/folder_sets/all_class_train_0.txt'
valid_class_folder = '/home/bokorn/src/generic_pose/generic_pose/training_sets/folder_sets/all_class_class_valid_0.txt' 
valid_folder = '/home/bokorn/src/generic_pose/generic_pose/training_sets/folder_sets/all_class_model_valid_0.txt'
...
results_folder = '/home/bokorn/results/result_imgs/eval_shapenet/' 
...
base_all = np.load(results_folder + 'alexnet_reg_shapenet_errs.npz')
base_45 = np.load(results_folder + 'alexnet_reg_shapenet45_errs.npz')

small_all = np.load(results_folder + 'alexnet_reg_shapenet_45de_errs.npz')
small_45 = np.load(results_folder + 'alexnet_reg_shapenet_45deg45_errs.npz')
