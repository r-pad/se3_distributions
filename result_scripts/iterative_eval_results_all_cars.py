...
def getModelFolders(render_folder, model_dict):
    render_files = glob.glob(render_folder + '/*/*/', recursive=True)
    models = set()
    for path in render_files:
        [model_class, model_name] = path.split('/')[-3:-1]
        models.add(model_dict[model_name])
...
#
#train_models = getModelFolders(train_folder, model_dict)
#valid_models = getModelFolders(valid_folder, model_dict)
#
...
#train_models = np.random.choice(train_models,10)
#valid_models = np.random.choice(valid_models,10)
...
weight_paths = [#'/home/bokorn/results/all_car/alex_reg_all_car/2018-05-07_06-52-39/weights',
                ...
                '/home/bokorn/results/all_car/alex_reg_all_car_maxest_45deg/2018-05-10_21-51-45/weights',
