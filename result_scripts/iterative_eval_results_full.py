...
iter_quats=[q for q in data['iter_quats']]
query_quats=[q for q in data['query_quats']]

results_folder = '/home/bokorn/results/result_imgs/iter_full_noclip/' 

dot_q_path = '/home/bokorn/results/car_42/alex_reg_car42_maxdot_45deg_quat/2018-04-11_06-22-46/weights'
...
#    experiment_name.append(path.split('/')[5])

experiment_name.append('alex_reg_car42')
weight_filenames.append('/home/bokorn/results/car_42/alex_reg_car42/2018-03-17_20-10-18/weights/latest.pth')
...
#weight_filenames.append('/home/bokorn/results/car_42/alex_reg_car42_45deg/2018-03-30_23-24-02/weights/best_quat.pth')
...
##np.savez(filename, iter_quats=iter_quats, query_quats=query_quats)
#data = np.load(filename)
#iter_quats=data['iter_quats']
#query_quats=data['query_quats']
...
for name, weight_file in zip(experiment_name, weight_filenames):
    ...
    filename = os.path.join(results_folder, name+'_latest_errs.npz')
    np.savez(filename, 
