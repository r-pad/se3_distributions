...
echo ${1}
python $SRC_DIR/training/class_ycb_trainer.py \
    --log_dir '/home/bokorn/results/ycb_finetune/class/cce_model_'${1} \
    --checkpoint_dir '/scratch/bokorn/results/ycb_finetune/class/cce_model_'${1} \
