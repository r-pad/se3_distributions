python ../../src/generic_pose/training/finetune_ycb_w_renders_trainer.py \
    --results_dir '/scratch/bokorn/results/ycb_finetune/010_potted_meat_can/random_and_exact_renders' \
    --benchmark_folder '/scratch/bokorn/data/benchmarks/ycb/YCB_Video_Dataset' \
    --renders_folder '/scratch/bokorn/data/benchmarks/ycb/YCB_Video_Dataset/base_renders/010_potted_meat_can/2_random' \
    --target_object 9 \
