...
python $SRC_DIR/training/finetune_ycb_w_renders_trainer.py \
    --log_dir '/home/bokorn/results/ycb_finetune/01_002_master_chef_can/random_renders_aug_imgnet_'${1} \
    --checkpoint_dir '/scratch/bokorn/results/ycb_finetune/002_master_chef_can/random_renders_aug_imgnet_'${1} \
