...
echo ${1}
python $SRC_DIR/training/finetune_ycb_w_zoomed_render.py \
    --log_dir '/home/bokorn/results/ycb_finetune/render_aug/rand_masked_model_'${1} \
    --checkpoint_dir '/scratch/bokorn/results/ycb_finetune/rand_masked_model_'${1} \
