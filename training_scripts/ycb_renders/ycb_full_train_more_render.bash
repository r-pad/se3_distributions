...
python $SRC_DIR/training/finetune_ycb_full_trainer.py \
    --log_dir '/home/bokorn/results/ycb_finetune/full_train_more_rend/model_'${1} \
    --checkpoint_dir '/scratch/bokorn/results/ycb_finetune/full_train_more_rend/model_'${1} \
