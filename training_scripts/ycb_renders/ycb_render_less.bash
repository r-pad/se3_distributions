...
python $SRC_DIR/training/finetune_ycb_w_renders_trainer.py \
    --log_dir '/home/bokorn/results/ycb_finetune/render_aug/less_aug_model_'${1} \
    --checkpoint_dir '/scratch/bokorn/results/ycb_finetune/less_aug_model_'${1} \
